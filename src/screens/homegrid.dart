...
class _HomeRouteState extends State<HomeRoute> {
  ...
  void initState() {
    super.initState();
    _cs.readCache().then((String value) {
      setState(() {
        print('*****CACHED-DATA ****');
        print(value);
      });
  ...
  Widget build(BuildContext context) {
    ...
    FutureBuilder _fb = FutureBuilder<Homedata>(
      ...
      builder: (context, snapshot) {
        ...
        return const CircularProgressIndicator(); //#default
      },
    );
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: _widgetOptions.elementAt(_BottomBarSelectedIndex),
